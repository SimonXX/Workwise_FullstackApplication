...
For development and testing purposes, the database password is exposed in the configuration to simplify the database setup and container initializati: *Remember to change it to a strong password*.
